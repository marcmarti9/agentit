...
Inspected 2026-08-26 from:

- https://x.com/jaimintf/status/2092332440434172325
- https://appllama.io/mcp
- https://github.com/Appllama/appllama-skills (MIT)

## Comparison to Agentit
...
| Security/provenance | Paid credits; read-only research; do not vendor upstream bodies; no catalog harvesting |
| How we know it helped | Simulator-verified flows vs generic RN output; research notes cite screen ids |

## Decision

Promote as catalog server `appllama`, stack `mobile_design`, skill `mobile-native-app-design`, profile `mobile`. Do not auto-activate.
