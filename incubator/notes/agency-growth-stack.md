# Agency growth stack — Agentit wiring

Scouted / wired: 2026-08-18

## Intent

Agency work is a **digital agency domain**, not only coding:
...
| `agency` | Growth plus incremental delivery and Git handoffs |

Enable examples:

```bash
agentit enable agency --project . --apply
...
- Optional: slim local adapters under `skills/` for agency-specific process.
